...
class TestCourseService:
    def setup_method(self):
        ...
        self.mock_course.to_dict = Mock(
            return_value=TestConstants.get_course_dict_response()
        )
    ...
    def test_get_all_exception(self):
        ...
        # Act & Assert
        expected_error = TestConstants.get_error_message(
            "fetch_all_courses", error=TestConstants.ERROR_DATABASE
        )
    ...
    def test_create_success(self):
        ...
        mock_created_course.to_dict.return_value = (
            TestConstants.get_course_dict_response()
        )
        ...
        with patch.object(
            CourseService,
            "_CourseService__dict_to_course",
            return_value=mock_created_course,
        ):
            # Act
    ...
    def test_create_with_invalid_category(self):
        ...
        with patch(
            "crud_flask.services.course_service.Course",
            return_value=mock_created_course,
        ):
            # Act & Assert
    ...
    def test_update_success(self):
        ...
        existing_course.to_dict.return_value = {
            "id": course_id,
            "name": TestConstants.UPDATED_COURSE_NAME,
        }
    ...
    def test_update_with_lessons_add_new(self):
        ...
        with patch.object(
            self.course_service, "_CourseService__dict_to_course"
        ) as mock_dict_to_course:
            ...
            with patch(
                "crud_flask.services.course_service.Lesson"
            ) as mock_lesson_class:
                ...
                existing_course.lessons.append.assert_called_once_with(
                    new_lesson_instance
                )
